...
start_(alice_is_paid_s63_c_2_A_ii_neg,"2017-12-31").
...
start_(alice_and_bob_s63_c_2_A_ii_neg,"2017-02-03").
...
start_(alice_and_bob_file_a_joint_return_s63_c_2_A_ii_neg,"2017-01-01").
end_(alice_and_bob_file_a_joint_return_s63_c_2_A_ii_neg,"2017-12-31").
