...
start_(alice_employer_s3306_b_10_A_pos,"2011-01-02").
end_(alice_employer_s3306_b_10_A_pos,"2019-10-10").
disability_(bob_is_disabled_s3306_b_10_A_pos).
agent_(bob_is_disabled_s3306_b_10_A_pos,bob_s3306_b_10_A_pos).
start_(bob_is_disabled_s3306_b_10_A_pos,"2019-10-10").
...
start_(bob_retires_s3306_b_10_A_pos,"2019-10-10").
...
start_(alice_pays_s3306_b_10_A_pos,"2019-10-10").
