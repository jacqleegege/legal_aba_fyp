...
patient_(alice_employed_s3306_c_11_neg,state_of_maryland).
...
agent_(alice_is_paid_s3306_c_11_neg,state_of_maryland).
...
% Test
:- \+ s3306_c_11(alice_employed_s3306_c_11_neg,state_of_maryland).
:- halt.
