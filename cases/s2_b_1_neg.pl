...
start_(alice_and_bob_s2_b_1_neg,"1992-02-03").
death_(alice_dies_s2_b_1_neg).
agent_(alice_dies_s2_b_1_neg,alice_s2_b_1_neg).
start_(alice_dies_s2_b_1_neg,"2014-07-09").
end_(alice_dies_s2_b_1_neg,"2014-07-09").
...
start_(charlie_and_bob_residence_s2_b_1_neg,"2004-01-01").
end_(charlie_and_bob_residence_s2_b_1_neg,"2019-12-31").
