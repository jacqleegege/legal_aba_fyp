...
start_(alice_and_bob_s2_b_3_A_neg,d1992_02_03).
death_(alice_dies_s2_b_3_A_neg).
agent_(alice_dies_s2_b_3_A_neg,alice_s2_b_3_A_neg).
start_(alice_dies_s2_b_3_A_neg,d2014_07_09).
end_(alice_dies_s2_b_3_A_neg,d2014_07_09).
...
start_(charlie_and_bob_residence_s2_b_3_A_neg,d2004_01_01).
end_(charlie_and_bob_residence_s2_b_3_A_neg,d2019_12_31).
...
end_(bob_is_a_nra_s2_b_3_A_neg,d2018_02_12).

% Test
:- \+ s2_b_3_A(bob_s2_b_3_A_neg,2019,d2019_01_01).
:- halt.
