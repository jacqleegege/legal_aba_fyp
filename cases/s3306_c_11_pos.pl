...
patient_(alice_employed_s3306_c_11_pos,canadian_government).
...
agent_(alice_is_paid_s3306_c_11_pos,canadian_government).
...
% Test
:- s3306_c_11(alice_employed_s3306_c_11_pos,canadian_government).
:- halt.
