...
% Facts
person(alice_s152_a_pos).
person(bob_s152_a_pos).
...
s152_c_1(bob_s152_a_pos,alice_s152_a_pos,2015).

% Test
:- s152_a(bob_s152_a_pos,alice_s152_a_pos,2015,d2014_01_01,d2015_12_31).
:- halt.
