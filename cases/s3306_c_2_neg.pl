...
location_name(usa).
location_name(private_home_s3306_c_2_neg).
...
purpose_(alice_employer_s3306_c_2_neg,domestic_service).
location_(alice_employer_s3306_c_2_neg,private_home_s3306_c_2_neg).
...
:- \+ s3306_c_2(alice_employer_s3306_c_2_neg,private_home_s3306_c_2_neg,2017).
:- halt.
