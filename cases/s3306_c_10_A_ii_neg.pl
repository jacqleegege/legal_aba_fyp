...
agent_(hopkins_is_a_university_s3306_c_10_A_ii_neg,johns_hopkins_university).
...
patient_(bob_employed_s3306_c_10_A_ii_neg,johns_hopkins_university).
...
agent_(bob_is_paid_s3306_c_10_A_ii_neg,johns_hopkins_university).
...
patient_(alice_goes_to_hopkins_s3306_c_10_A_ii_neg,johns_hopkins_university).
...
location_(alice_goes_to_class_s3306_c_10_A_ii_neg,johns_hopkins_university).
