...
start_(alice_and_bob_s2_b_1_A_i_pos,"1992-02-03").
death_(alice_dies_s2_b_1_A_i_pos).
agent_(alice_dies_s2_b_1_A_i_pos,alice_s2_b_1_A_i_pos).
start_(alice_dies_s2_b_1_A_i_pos,"2014-07-09").
end_(alice_dies_s2_b_1_A_i_pos,"2014-07-09").
...
start_(charlie_is_son_s2_b_1_A_i_pos,"2000-10-09").
...
start_(charlie_and_bob_residence_s2_b_1_A_i_pos,"2004-01-01").
end_(charlie_and_bob_residence_s2_b_1_A_i_pos,"2019-12-31").
